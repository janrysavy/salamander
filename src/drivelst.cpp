...
// ****************************************************************************
// this code comes from the Knowledge Base and is used to obtain information about the drive media type
                         ...
                         int* postCmd, void** postCmdParam, BOOL* fromContextMenu)
{
    ...
    // normally this is not a post command, so reset these values
    *PostCmd = 0;
    *PostCmdParam = NULL;
