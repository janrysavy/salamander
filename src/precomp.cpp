...
preferably with a regex that matches everything in between (width specification, etc.) ... so it also finds %08X, etc.
this will be a mess to sift through for a few days
----
