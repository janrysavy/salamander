...
extern BOOL WindowsVistaAndLater; // Windows Vista or later from the NT line (6.0+)
extern BOOL WindowsXP64AndLater;  // Windows XP 64, Vista or later (5.2+)

// Open Salamander interfaces—valid from InitUtils() until the plugin shuts down
extern CSalamanderGeneralAbstract* SG;
extern CSalamanderGUIAbstract* SalGUI;

// ****************************************************************************
//
// CCS -- critical-section wrapper that initializes and destroys itself
//
...
// ****************************************************************************
//
// CDialogStack -- stores the window hierarchy on a stack; the top entry serves
// as the parent for message and error boxes, and each thread keeps its own stack
//
...
// ****************************************************************************
//
// CDialogEx -- automatically centers the dialog and manages its HWND on the
// DialogStack
//
...
// ****************************************************************************
//
// Thread-safe counter that raises an event whenever the value changes
//
...
// ****************************************************************************
//
// CArgv -- builds an argument vector from a command-line string
//
