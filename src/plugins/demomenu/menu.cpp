                                            ...
                                            HWND parent, int id, DWORD eventMask)
{
    ...
    case MENUCMD_TESTCMD:
    {
        ...
        //      SalamanderGeneral->SetUserWorkedOnPanelPath(PANEL_SOURCE);  // treat this command as working with the path (appears in Alt+F12)
        break;
    }
    ...
    return FALSE; // do not clear panel selections
}
