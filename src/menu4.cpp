...
MENU_TEMPLATE_ITEM MainMenuTemplate[] =
    {
        ...
        {MNTT_IT, IDS_MENU_EDIT_PASTE, MNTS_B | MNTS_I | MNTS_A, CM_CLIPPASTE, IDX_TB_CLIPBOARDPASTE, 0, &EnablerPaste}, // !ATTENTION! The item is replaced with "Change Directory" when there is text on the clipboard (handled in CMainWindow/WM_USER_INITMENUPOPUP)
...
MENU_TEMPLATE_ITEM ArchivePanelMenuTemplate[] =
    {
        {MNTT_PB, -1, MNTS_B | MNTS_I | MNTS_A, 0, -1, 0, NULL},
        {MNTT_IT, IDS_ARCHIVEMENU_CLIPPASTE, MNTS_B | MNTS_I | MNTS_A, CM_CLIPPASTE, IDX_TB_CLIPBOARDPASTE, 0, &EnablerPaste}, // !ATTENTION! The item is replaced with "Change Directory" when text is on the clipboard (handled in ShellAction()/saContextMenu/onlyPanelMenu)
        {MNTT_PE},                                                                                                             // terminator
};
