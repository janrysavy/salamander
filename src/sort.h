...
// comparison for two files, first key is name, second key is extension, returns -1, 0, or 1 like strcmp
...
// StrICmp for regional-settings-sort and detect-numbers-sort; in 'numericalyEqual'
// (when not NULL) returns TRUE if the strings are numerically equal (e.g. "a01" and "a1")
...
// strcmp for regional-settings-sort and detect-numbers-sort; in 'numericalyEqual'
// (when not NULL) returns TRUE if the strings are numerically equal (e.g. "a01" and "a1")
