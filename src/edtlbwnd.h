...
public:
    // if the itemIndexes variable is TRUE, itemID values are treated as
    // indexes and handled as such when inserting, moving and deleting
    ...
    // returns the selected item index; for a new item it is one more than
    // the number of items
    ...
    // enables drag&drop of items; 'hMarkWindow' is the window where the drop
    // marker will be drawn. If 'hMarkWindow' is NULL, drag&drop is disabled
